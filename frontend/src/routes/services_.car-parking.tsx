...
function CarParkingPage() {
    ...
    return (
        <div className="bg-white overflow-hidden scroll-smooth">
            ...
            {/* ─── HERO SECTION ─── */}
            <section className="relative min-h-[460px] sm:min-h-[540px] md:min-h-[600px] flex items-center pt-24 sm:pt-32 pb-12 overflow-hidden bg-slate-950">
                ...
                <Container className="relative z-10 text-white">
                    ...
                    >
                        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white leading-[1.2] mb-4 sm:mb-6">
                            Intelligent <br />
            ...
            <section className="py-14 sm:py-20 lg:py-28 bg-white">
                <Container>
                    ...
                    {/* HEADER */}
                    <div className="mb-10 sm:mb-16 lg:mb-20 space-y-3 sm:space-y-4 max-w-2xl text-center sm:text-left">
                        <h2 className="text-2xl sm:text-3xl font-bold text-[#1A3263] tracking-tight">
                            Why Choose Car Parking Systems
                        </h2>
                        <div className="w-16 sm:w-20 h-1 bg-red-600 mx-auto sm:mx-0" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        {[
                            ...
                            <motion.div
                                ...
                                className="p-5 border border-gray-200 bg-white hover:border-gray-300 rounded-lg transition-all duration-200"
                            >
                                {/* ICON */}
            ...
            <section className="py-14 sm:py-20 lg:py-24 bg-[#F8F9FA]">
                <Container>

                    {/* HEADER */}
                    <div className="mb-10 sm:mb-16 max-w-3xl space-y-3 sm:space-y-4 text-center sm:text-left">
                        <h2 className="text-2xl sm:text-3xl font-bold text-[#1A3263] leading-tight">
                        ...
                        <div className="w-16 h-[2px] bg-red-600 mx-auto sm:mx-0" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6">
                        ...
                        <div className="md:col-span-8 flex flex-col md:flex-row bg-white border border-gray-200 overflow-hidden rounded-lg hover:border-gray-300 transition-colors">
                            <div className="p-5 sm:p-8 md:w-1/2 space-y-3">
                                <h4 className="text-base sm:text-lg font-semibold text-[#1A3263]">
                        ...
                        {/* 5 */}
                        <div className="md:col-span-12 bg-white border border-gray-200 rounded-lg p-5 sm:p-8">
                            <h4 className="text-base sm:text-lg font-semibold text-[#1A3263] mb-2">
                                System Integration
                            </h4>
