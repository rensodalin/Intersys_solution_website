...
export function RegisterForm({ onSubmit, loading, formData, handleInputChange }: RegisterFormProps) {
    ...
    <form onSubmit={onSubmit} className="space-y-8">
      <div className="space-y-6">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex gap-6">
            <label className="flex items-center gap-2.5 cursor-pointer group">
              ...
              />
              <span className="text-sm text-gray-700 group-hover:text-black transition-colors">Male</span>
            </label>
            <label className="flex items-center gap-2.5 cursor-pointer group">
              <input
                type="radio"
                ...
                className="accent-black w-4 h-4 cursor-pointer"
              />
              <span className="text-sm text-gray-700 group-hover:text-black transition-colors">Female</span>
            </label>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2.5">
            <label className="text-[11px] font-medium text-gray-500 tracking-wide uppercase">First name</label>
            <input
              type="text"
              name="firstName"
              required
          ...
          <div className="space-y-2.5">
            <label className="text-[11px] font-medium text-gray-500 tracking-wide uppercase">Last name</label>
            <input
              type="text"
              name="lastName"
              required
        ...
        <div className="space-y-3">
          <label className="text-[11px] font-medium text-gray-500 tracking-wide uppercase">Country & Phone</label>
        ...
        {/* Email */}
        <div className="space-y-2.5">
          <label className="text-[11px] font-medium text-gray-500 tracking-wide uppercase">Email</label>
          <input
            type="email"
            name="email"
            required
        ...
        {/* Password */}
        <div className="space-y-2.5">
          <label className="text-[11px] font-medium text-gray-500 tracking-wide uppercase">Password</label>
