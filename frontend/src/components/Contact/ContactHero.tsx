...
export function ContactHero() {
    return (
        <section className="relative bg-[#0A0F1A] pt-36 pb-28 text-white overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
                ...
                >
                    ...
                    <p className="text-gray-300 max-w-2xl mx-auto">
                        Have a project in mind or need expert advice? Reach out to our
                        team and let’s build something exceptional together.
                    </p>
                </motion.div>
            </div>
        </section>
