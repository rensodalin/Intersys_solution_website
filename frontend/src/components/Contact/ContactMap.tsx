  ...
  return (
    <section className="pb-24">
      <div className="max-w-6xl mx-auto px-6">
        <div className="rounded-md overflow-hidden h-[500px] shadow-2xl relative group">
          <iframe
          ...
          <a
            ...
            className="absolute bottom-6 left-6 bg-white p-4 rounded-lg shadow-lg border border-gray-100 hover:bg-red-50 transition-colors group/card"
          >
            <p className="font-bold text-sm text-gray-900 flex items-center gap-2">
              Intersys Solutions HQ
