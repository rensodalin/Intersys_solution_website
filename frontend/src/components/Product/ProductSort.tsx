...
export function ProductSort({
    ...
    return (
        <div className="sticky top-16 z-30 bg-white py-2 mb-6 border-b border-gray-100">
            <div className="bg-white border border-gray-200 rounded-sm p-3 md:p-4 shadow-sm flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
                {/* Search Input Box */}
                    ...
                    {onToggleFilter && (
                        <button
                            ...
                            className={cn(
                                ...
                                isFilterOpen
                                    ? "bg-[#C3110C] border-[#C3110C] text-[#ffffff] hover:bg-[#1A3263] hover:border-[#1A3263]"
