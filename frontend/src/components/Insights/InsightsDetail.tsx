...
export function InsightsDetail(props: InsightsDetailProps) {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[45vh] min-h-[400px] overflow-hidden pt-24 md:pt-28">
        <img
          src={image && image[0]}
          alt={title}
        ...
        <Container className="relative h-full flex flex-col justify-between py-10">
          ...
          <div className="max-w-2xl">
            ...
            <motion.p
              ...
              className="mt-4 text-sm md:text-base text-white/75 leading-relaxed max-w-xl"
            >
              {desc}
            </motion.p>
          </div>
      ...
      <div className="bg-[#0A0F1A] text-white border-y border-slate-800 py-3.5 shadow-sm">
        <Container className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#C3110C] hover:bg-[#1A3263] text-white text-xs font-bold px-4 py-2 rounded transition-all shadow cursor-pointer whitespace-nowrap"
          >
      ...
      <section className="py-16 md:py-20">
        <Container>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-[#162E93] tracking-tight">
              About The Project
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 bg-gray-50 rounded-lg p-8 border border-gray-200/80 shadow-sm flex flex-col justify-center min-h-[400px]">
              <div
                className="text-gray-600 text-sm leading-relaxed space-y-4 font-normal"
      ...
      <section className="py-16 md:py-20 bg-slate-50/60 border-y border-gray-100">
        <Container>
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-[#162E93] tracking-tight">
          ...
          {/* Banner Image with Button (Original UI) */}
          {(articleBannerImage || section1SubImage || image?.[2]) && (
            <div className="relative h-[280px] rounded-sm overflow-hidden my-12 group shadow-md">
              <img
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex items-end justify-between p-8">
                ...
                {pdfUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-[#C3110C] hover:bg-[#1A3263] text-white text-xs font-bold px-4 py-2.5 rounded shadow transition-colors no-underline whitespace-nowrap"
                  >
      ...
      {/* ─── TECHNICAL DEPLOYMENT GALLERY (Original UI) ─── */}
