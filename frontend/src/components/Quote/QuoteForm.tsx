...
//         defaultValues: {
//             cataloguePrinted: false,
//             catalogueElectronic: false,
//             products: [
//                 { qty: "", productNo: "", description: "", application: "" },
//             ],
...
//                 <div className="max-w-7xl mx-auto px-6 pt-20 pb-36 flex flex-col lg:flex-row items-center justify-between relative z-10 gap-12">
...
//                     >
//                         {/* glow behind image */}
//                         <div className="absolute inset-0 -bottom-8 bg-[#D62828]/20 blur-3xl rounded-full scale-75" />
//                         <img
//                             src={engineerImg}
//                             alt="Engineer"
//                             className="w-[500px] relative drop-shadow-2xl"
//                         />
//                     </motion.div>
...
//                     className="bg-white rounded-3xl shadow-2xl shadow-black/10 border border-gray-100 overflow-hidden"
//                 >

//                     {/* form header bar */}
//                     <div className="border-b border-gray-100 px-10 md:px-14 py-6 flex items-center justify-between">
//                         <div>
//                             <h2 className="text-lg font-bold text-[#0A0F1A]">Quote Request Form</h2>
...
//                     <form onSubmit={handleSubmit(onSubmit)} className="p-10 md:p-14 space-y-14">
...
//                                 className="group relative inline-flex items-center gap-3 px-10 py-4 rounded-2xl bg-[#D62828] text-white text-sm font-semibold shadow-lg shadow-[#D62828]/25 hover:shadow-[#D62828]/40 hover:bg-[#b82020] hover:scale-[1.02] active:scale-[0.99] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
//                             >
//                                 {isSubmitting ? (
//                                     <>
