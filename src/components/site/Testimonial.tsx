    ...
    <section className="bg-white py-24 border-t border-border">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="absolute top-6 right-8 text-[#ff3b3b]/10 pointer-events-none transform transition-transform group-hover:scale-110">
            ...
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-12 h-12 bg-[#071321] shadow-md rounded-lg flex-shrink-0" />
              <div>
                <div className="font-bold text-[#071321] text-sm">Project Manager</div>
          ...
          >
            ...
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-12 h-12 bg-[#071321] shadow-md rounded-lg flex-shrink-0" />
              <div>
                <div className="font-bold text-[#071321] text-sm">Head of Facilities</div>
