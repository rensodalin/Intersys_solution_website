...
export function Footer() {
  return (
    <footer className="bg-[#071321] text-white border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="grid h-10 w-10 place-items-center rounded-md border border-white/10 text-white/70 hover:bg-[#0077b5] hover:border-[#0077b5] hover:text-white transition-all shadow-sm">
                <Linkedin className="h-4 w-4" />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="grid h-10 w-10 place-items-center rounded-md border border-white/10 text-white/70 hover:bg-[#229ED9] hover:border-[#229ED9] hover:text-white transition-all shadow-sm">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/portfolio" className="text-[15px] text-white/60 hover:text-[#ff3b3b] transition-colors flex items-center gap-3">
                  <span /> Projects
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-[15px] text-white/60 hover:text-[#ff3b3b] transition-colors flex items-center gap-3">
                  <span /> About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-[15px] text-white/60 hover:text-[#ff3b3b] transition-colors flex items-center gap-3">
                  <span /> Contact
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-start gap-4">
                <div>
                  ...
                  <div className="text-[14px] text-[#ff3b3b] font-bold">Closed</div>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                <Phone className="w-[18px] h-[18px] text-[#ff3b3b] shrink-0 mt-1" />
                <a href="tel:077602334" className="text-[15px] text-white/80 hover:text-white transition-colors">
                  077 602 334
                </a>
              </li>
              <li className="flex items-start gap-4">
                <Mail className="w-[18px] h-[18px] text-[#ff3b3b] shrink-0 mt-1" />
                <a href="mailto:sochet@intersys-solutions.com" className="text-[15px] text-white/80 hover:text-white transition-colors break-all">
                  sochet@intersys-solutions.com
                </a>
              </li>
              <li className="flex items-start gap-4">
                <MapPin className="w-[18px] h-[18px] text-[#ff3b3b] shrink-0 mt-1.5" />
                <span className="text-[14px] text-white/60 leading-relaxed">
                  Street 07, Krang Thmey Village, Songkat kok khlang, khan sen sok, Phnom Penh, Cambodia.
                </span>
              </li>
            </ul>
          </div>
