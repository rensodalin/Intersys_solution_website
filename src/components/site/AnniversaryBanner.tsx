        ...
        <section className="relative min-h-[400px] md:min-h-[500px] flex items-center overflow-hidden bg-[#0a1a2f] border-y border-white/5">
            ...
            <div className="absolute inset-0 opacity-20 pointer-events-none">
                <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    ...
                    <circle cx="50" cy="50" r="40" fill="none" stroke="white" strokeWidth="0.02" strokeDasharray="1 1" />
                </svg>
            </div>
            ...
            <Container className="relative z-10 py-12 md:py-16">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
                    ...
                    <div className="max-w-2xl text-left">
                        ...
                        >
                            Supported by a strong team working on inspiring projects.
                            Expertise, quality, and reliability made our reputation and
